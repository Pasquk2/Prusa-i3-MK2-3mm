...
extradius_difference = (25-22.3)/2;
extbodyheight_difference = (32 - 26);
extheight_difference = (53-46);
extheater_difference = extheight_difference - extbodyheight_difference;
...
difference(){
    // Main
    union(){
        translate ([0,0,-extradius_difference]) cube([35,44 +extbodyheight_difference,15 + extradius_difference]);
        // P.I.N.D.A. Probe mount
       translate([0,extbodyheight_difference,0]) difference(){
       translate([-15.5,40,0-extradius_difference])cube([21.5,5,14+extradius_difference]);
         translate([9,41,-1]) rotate([0,0,45]) translate([0,-5,-0.1]) cube([10,12,20]);    
        }
        translate([-7.5,17,0-extradius_difference])cube([8,8.5,2+extradius_difference]); // P.I.N.D.A. and Fan cable tray guide
        //fan nice look
        //TODO
        translate([35,0,0-extradius_difference]) cube([10,12+extbodyheight_difference,15+extradius_difference]);
    }
    // Fan nice look edge cut
    translate([+52.6,-3.49,0]) rotate([0,0,-45-180]) translate([0,-5,-0.1-extradius_difference]) cube([10,10,20+extradius_difference]);  
    
    // P.I.N.D.A. Probe mount edge cut
translate([0,extbodyheight_difference,0])     translate([-28.5,40,5]) rotate([0,30,0]) translate([0,-5,-0.1]) cube([10,12,20]);   // Top
translate([0,extbodyheight_difference,0])     translate([-33,40,-5]) rotate([0,60,0]) translate([0,-5,-0.1]) cube([12,12,20]); // Bottom
    
    
    // P.I.N.D.A. probe mount hole
translate([0,extbodyheight_difference,0])      translate([35/2,0,6]){
     ...
     translate([-4.5,20,-1-extradius_difference]) cube([4.499,3.5+5,5+extradius_difference]);
     // P.I.N.D.A. and Fan cable tray edge cut
     translate([-10,22,-1-extradius_difference])rotate([0,0,45]) cube([10,5,10+extradius_difference]);
     translate([-13,16.5,-1-extradius_difference])rotate([0,0,-45]) cube([10,5,10+extradius_difference]);
...
// Extruder cables path
    translate([33+4,10,-1 - extradius_difference]) cylinder(r=2, h=17+extradius_difference,$fn=30);
    translate([33+4,12+extbodyheight_difference/2,9-extradius_difference]) cube([4,4+extbodyheight_difference,20+extradius_difference], center=true);  
    //TODO 
translate([0,extbodyheight_difference,0])     extruder_nozzle_cooling();
...
// Motor visualisation
    translate([-42 - filament_difference  - hob_difference,-42,-1-extradius_difference]) %cube([42,42,1]);
    translate([-21 - filament_difference  - hob_difference,-21,0-extradius_difference])%cylinder(r=2.5, h=20, $fn=30);
    translate([-21 - filament_difference  - hob_difference,-21,8-extradius_difference])%cylinder(r=4.5, h=13, $fn=30);
    translate([-21 - filament_difference - hob_difference,-21,8-extradius_difference])#%cylinder(r=3.5, h=13, $fn=30);
...
// base
difference(){
    translate([-42,-42,0-extradius_difference]) cube([42,42,30+extradius_difference]);
    //main cut
    translate([-21,-19.5-10-3,-1-extradius_difference]) cube([42,23,32+extradius_difference]);
    translate([-15,-49.5,-1-extradius_difference]) cube([42,23,32+extradius_difference]);
    translate([-51,-33,-1]) rotate([0,65,0]) cube([10,25,10]);
    translate([-35/2+3+1.8+0.5,-41,2+3+2.5])cube([42,42,32]);
    //base round cutout
    translate([-21,-21,-2-extradius_difference]) cylinder(r=11.5, h=33+extradius_difference, $fn=200);
    
    //filament hole
    translate([-35/2,-42,15])rotate([-90,0,0])cylinder(r=3.5/2, h=20, $fn=20);
    translate([-35/2,-42,15])rotate([-90,0,0])cylinder(r2=3.5/2,r1=3.5/2, h=1.5, $fn=20);
}
...
//        
       ...
       // round corners
        translate([-2.5,-42+2.5,0]) rotate([0,0,-45]) translate([0,-5,-0.1-extradius_difference]) cube([10,10,10+extradius_difference]);   
        translate([-42+2.5,-42+2.5,0]) rotate([0,0,-45-90]) translate([0,-5,-0.1-extradius_difference]) cube([10,10,33+extradius_difference]);  
...
difference(){
    // Main
    union(){
        translate([0,0,15]) cube([35,44+extbodyheight_difference,15+extradius_difference]);
        
translate([0,extbodyheight_difference,0])         translate([34,42,23]) cube([1,18,7+extradius_difference]);
translate([0,extbodyheight_difference,0])        translate([34,56,23]) cube([4,5,7+extradius_difference]);
        //fan nice look
        translate([35,0,15]) cube([10,12+extbodyheight_difference,15+extradius_difference]);
    }
    // Fan nice look edge cut
    translate([+52.6,-3.49,0]) rotate([0,0,-45-180]) translate([0,-5,-0.1]) cube([10,10,32]);  
    
translate([0,extbodyheight_difference,0])    translate([38,58.3,20]) rotate([0,0,45]) cube([5,5,15]);
    
     extruder_nozzle_cut();  

     
// Extruder cables path
    translate([33+4,10,-1]) cylinder(r=2, h=32+extradius_difference,$fn=30);
    translate([33+4,12+extbodyheight_difference/2,22]) cube([4,4+extbodyheight_difference,20+extradius_difference], center=true);  
...
translate([6,33,27+extradius_difference])rotate([0,0,67]) cube([8,24,3]);    // Connecting cube
translate([35/2+12-42.75,6.5+38.5,25+extradius_difference])cylinder(r=5.8, h=5, $fn=6); // Hexagon at the end

// Print fan nozzle mount - right
translate([0,extbodyheight_difference,0])    translate([5,61-5,24+extradius_difference])cylinder(r=7.5/2, h=6, $fn=6);
    

// Print colling airway
translate([0,extbodyheight_difference,0])     translate([8,44,28+extradius_difference])rotate([0,0,0]) cube([27,9,2]);
translate([0,extbodyheight_difference,0])    difference(){
     translate([8,51.6,28.5+extradius_difference])rotate([-45,0,0]) cube([27,7,2]);
     translate([7,57,20+extradius_difference])rotate([0,0,0]) cube([29,7,12]);
     translate([7,53,22]+extradius_difference)rotate([0,0,0]) cube([29,7,2]);
    }    
    
translate([0,extbodyheight_difference,0])    translate([34,44,24+extradius_difference])rotate([0,0,0]) cube([1,13,6]);  
    translate([8-5,44,24+extradius_difference])rotate([0,0,0]) cube([1+5,13+extbodyheight_difference,6]);  
...
translate([0,extbodyheight_difference,0]) difference(){
    ...
    // Trim
translate([0,extbodyheight_difference,0])    translate([-35,0,0])cube([35,43,35]);
...
translate([0,extbodyheight_difference,0])    translate([5,61-5,20])cylinder(r=3/2, h=12+extradius_difference, $fn=30);
...
translate([21+filament_difference + hob_difference,-21,0]){
 ...
 module extruder_nozzle_cut(){
    ...
    // Main body
    translate([35/2,13,15]) rotate([-90,0,0]) cylinder(r=11.53+extradius_difference, h=33.001+extbodyheight_difference, $fn=80);
